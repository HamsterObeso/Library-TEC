...
//Esta función es la encargada de recibir la información y meter los datos de la persona en una lista
public class ListaClientes{
    ...
    //función que saca el largo de la lista y retorna la cantidad
    ...
    //devuelve el nodo de la lista clientes
    ...
    //función que borra la posición en la lista seleccionada
